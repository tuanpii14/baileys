# Contributing to Ziperr

Thanks for your interest in contributing! Ziperr is a fork of
...
- Include: Node.js version, `@ziperr/baileys` version, a minimal reproduction,
...
```bash
git clone https://github.com/ziperr/baileys.git
cd baileys
npm install
npm run build:tsc
npm test
