# <div align='center'>Ziperr</div>

<p align="center">

  <img src="https://ziperrimg2.lovable.app/f/a3ke3knfbf.jpg" width="180" alt="ziperr"/>
...
[![GitHub](https://img.shields.io/badge/source-GitHub-black.svg)](https://github.com/ziperr/Baileys)
[![Node](https://img.shields.io/badge/node-%3E%3D20-brightgreen.svg)](package.json)

A WebSockets library for interacting with WhatsApp Web, maintained under the **Ziperr** brand.
...
```bash
npm install github:ziperr/Baileys
```

Or add it to your `package.json` manually:
```json
"dependencies": {
  "@ziperr/baileys": "github:regencybeatrik/ziperr"
}
```
...
```json
"dependencies": {
  "@whiskeysockets/baileys": "github:regencybeatrik/ziperr"
}
```
...
```bash
npm install github:regencybeatrik/ziperr#main
```
...
const client = makeWASocket({
  browser: Browsers.ziperr('Chrome'),
...
await client.relayMessage(m.chat, {
  conversation: "Hello from Ziperr"
}, {
  noSelfSync: true
});
...
Ziperr is a fork of [Baileys](https://github.com/WhiskeySockets/Baileys), originally created by
